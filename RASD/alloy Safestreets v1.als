...
sig DangerousInGeneral extends dangerousBool{}//a signature that indicates that the street is considered as dangerous
sig NotDangerousInGeneral extends dangerousBool{}//a signature that indicates that the street is not considered as dangerous
...
/*This represent one single data given by the municipality. This data is used to mine them in order to retrieve 
...
disabled and the driving License. This signature contains also the driving license of the user.*/
...
/*This signature represents a user who belongs to the cylists category*/
