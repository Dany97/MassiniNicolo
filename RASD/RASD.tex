...
\end{itemize}
We also have a security policy for the passwords. The user must insert a password composed at least by 8 characters, at least a number and at least a capital letter.


\subsubsection{Maintainability}
The software will have to be developed in order to be maintained in future and, eventually, to add some new features.
So it has to be programmed avoiding code duplication, writing readable code with a valid and understandable documentation.
